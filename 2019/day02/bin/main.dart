...
void main() {
  ...
  for(var noun=0; noun <= 99; noun++) {
    for(var verb=0; verb <= 99; verb++) {
      if (runWithArgs(data, noun, verb) == targetValue) {
        var result = 100 * noun + verb;
        print('Found noun ($noun) and verb ($verb). Result is $result.');
        return;
      }
    }
  }
