...
int main() {
  ...
  test("feedback amplification case 1", () {
    var code = [3,26,1001,26,-4,26,3,27,1002,27,2,27,1,27,26,27,4,27,1001,28,-1,28,1005,28,6,99,0,0,5];
    var signal = amplifyWithFeedback(code, [9,8,7,6,5]);
    expect(signal, 139629729);
  });

  test("feedback amplification case 2", () {
    ...
    var signal = amplifyWithFeedback(code, [9,7,8,5,6]);
    expect(signal, 18216);
  });
}
